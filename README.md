...
## ✨ 功能亮点
- 🖱️ **拖拽或点击加载**：支持直接拖拽图片到窗口，或通过菜单栏/按钮选择
- 📁 **批量处理 + 翻页浏览**：选择文件夹，逐张查看并调整参数，支持进度条和取消
- 🎛️ **实时自动转换**：调节滑块时自动生成像素画，无需手动点击
- 🎨 **复古色盘预设**：内置 GameBoy、NES、CGA、Commodore 64、ZX Spectrum、Atari 2600、PICO-8 等经典配色
- ✏️ **像素画编辑器**：支持画笔/橡皮/框选，可复制/粘贴/移动像素区域，支持撤销/重做
- 🔍 **图片缩放**：滚轮缩放 + 按钮控制 + 双击重置
...
- 🐧 **Linux 字体检测**：自动检测并配置中文字体
- 🔄 **滑块滚轮支持**：滚轮直接调节参数，操作更快捷
- 📂 **菜单栏**：完整的文件/功能/帮助菜单，操作更专业
